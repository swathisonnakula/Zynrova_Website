          ...
          <div className="grid lg:grid-cols-2 gap-1 items-center">
            <div>
              ...
              <p className="text-white/70 text-lg mb-8 leading-relaxed">
                Delivering innovative digital solutions across diverse
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <p className="text-white/70 leading-relaxed">
                Every industry has unique challenges and goals. We design and
                develop digital solutions tailored to your specific needs,
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Our Industry-
              <span className="text-[#FF6B6B]">Focused Approach</span>
            </h2>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8 py-10">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Services We Deliver{" "}
              <span className="text-[#FF6B6B]">Across Industries</span>
            </h2>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <ServiceIconCard icon="/web-dev.png" title="Web Development" />
            <ServiceIconCard icon="/ui-ux.png" title="UI/UX Design" />
            <ServiceIconCard
              icon="/app-dev.png"
              title="Mobile App Development"
            />
            <ServiceIconCard icon="/graphic.png" title="Graphic Design" />
            <ServiceIconCard
              icon="/digital-marketing.png"
              title="Digital Marketing"
            />
            <ServiceIconCard icon="/testing.png" title="Software Testing" />
          </div>
        </div>
      </section>
...
function ApproachItem({
  ...
  return (
    <div className="flex gap-4 items-center">
      <div className="w-16 h-16 rounded bg-white/5 flex items-center justify-center text-2xl shrink-0 p-2">
        <Image
          src={icon}
          alt="Industry Solutions"
          width={100}
...
function ServiceIconCard({ icon, title }: { icon: string; title: string }) {
  return (
